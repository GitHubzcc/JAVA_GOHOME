...
public class HttpUtils {
	...
	public static void getSubmitCodeBy12306(InputStream in,final HomeMethods order_oage) {
		...
		String userName = order_oage.home_page.passengerList.getModel().getElementAt(0).toString();
		...
		JLabel order_citi = new JLabel(order_oage.home_page.setOutFidld.getText()+"—>"+order_oage.home_page.destinationField.getText());
		order_citi.setBounds(168, 43, 88, 15);
		order_citi.setFont(new Font("微软雅黑", Font.BOLD, 12));
		frame2.getContentPane().add(order_citi);

		String seatType = order_oage.home_page.seatTypeList.getModel().getElementAt(0).toString();
